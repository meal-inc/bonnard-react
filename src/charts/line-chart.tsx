...
export function LineChart({ data, x, y, title, series, type, yFmt, y2, y2Fmt, y2SeriesType }: AxisChartProps) {
  ...
  const { series: echartsSeriesList, showLegend } = toEChartsSeries(
    result, 'line', type, undefined, useTimeAxis ? result.labels : undefined, y2Config,
  );
